...
//file_put_contents('/tmp/api_debug.log', "INFO METHOD CALLED AT " . date('Y-m-d H:i:s') . "\n", FILE_APPEND);
//file_put_contents('/tmp/api_debug.log', "SESSION DATA: " . print_r($this->session->data, true) . "\n", FILE_APPEND);
//file_put_contents('/tmp/api_debug.log', "POST DATA: " . print_r($this->request->post, true) . "\n\n", FILE_APPEND);
