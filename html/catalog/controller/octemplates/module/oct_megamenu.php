...
class ControllerOCTemplatesModuleOctMegamenu extends Controller {
    public function index() {
        ...
        if ($this->config->get('oct_megamenu_status')) {
	        ...
	        $data['items'] = $this->cache->get('octemplates.megamenu.' . (int) $this->config->get('config_language_id') . '.' . (int) $this->config->get('config_store_id') . '.' . $oct_webP);
	        ...
	        if (isset($data['items']) && empty($data['items'])) {
	            ...
	            $this->cache->set('octemplates.megamenu.' . (int) $this->config->get('config_language_id') . '.' . (int) $this->config->get('config_store_id') . '.' . $oct_webP, $data['items']);
	        }
