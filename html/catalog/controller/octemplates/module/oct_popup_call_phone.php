...
class ControllerOCTemplatesModuleOctPopupCallPhone extends Controller {
    ...
    protected function validate() {
        ...
        if (isset($this->request->post['telephone']) && !empty($oct_popup_call_phone_data['mask'])) {
            ...
            if ((isset($oct_popup_call_phone_data['telephone']) && $oct_popup_call_phone_data['telephone'] == 2) && utf8_strlen(str_replace(['_','-','(',')','+',' '], "", $this->request->post['telephone'])) < $phone_count) {
                $this->error['telephone'] = $this->language->get('error_telephone_mask');
            }
        } elseif (isset($this->request->post['telephone']) && ((isset($oct_popup_call_phone_data['telephone']) && $oct_popup_call_phone_data['telephone'] == 2) && (utf8_strlen(str_replace(['_','-','(',')','+',' '], "", $this->request->post['telephone'])) > 15 || utf8_strlen(str_replace(['_','-','(',')','+',' '], "", $this->request->post['telephone'])) < 3))) {
