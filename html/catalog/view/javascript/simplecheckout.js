(function($) {
    window.Simplecheckout = function(params) {
		...
		//Coupon Cart
const foo = document.querySelector('input[name=coupon]')
const bar = document.getElementById('bar')
const secretPhrase = 'paska2024'
foo.addEventListener('input', function(){
  if (this.value === secretPhrase) {
    bar.classList.remove('bespdost');
	bar1.classList.add('bespdost')
  }
})
//Coupon Cart
