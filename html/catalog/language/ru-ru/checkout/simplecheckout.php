...
$_['error_coupon']                   = 'Ошибка: купон либо недействителен, либо недостаточная сумма заказа, либо истек срок его действия, либо достигнут предел его использования!';
...
$_['text_besp']   = '
<strong>БЕСПЛАТНАЯ ДОСТАВКА</strong> оплаченных заказов НЕАКЦИОННЫХ ТОВАРОВ ДО 30 КГ:<br>
