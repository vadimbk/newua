...
$_['text_log_details_3_x']                  = 'Проверьте <a href="%1">Система &gt; Инструмены &gt; Журнал ошибок</a> более детально.';
$_['text_loading_notifications']            = 'Получение сообщений';
$_['text_retry']                            = 'Повторить попытку';
$_['text_used_category_ids']                = 'Идентификаторы используемых в настоящее время КАТЕГОРИЙ находятся между %1 и %2.';
$_['text_used_product_ids']                 = 'Идентификаторы используемых в настоящее время ТОВАРОВ находятся между %1 и %2.';
...
$_['entry_manufacturer_filter']                 = 'Ограничить экспорт товаров по производителям:';
...
$_['help_category_filter']                  = '(Необязательно, оставьте пустым, если не требуется)';
...
$_['help_manufacturer_filter']              = '(Необязательно, оставьте пустым, если не требуется)';
