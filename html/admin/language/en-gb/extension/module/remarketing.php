...
$_['entry_remarketing_feed_color']   = 'color - product attribute ID (!)';
$_['entry_remarketing_feed_size']   = 'size - product attribute ID (!)';
$_['entry_remarketing_feed_material']   = 'material - product attribute ID (!)';
$_['entry_remarketing_feed_gender']   = 'gender - product attribute ID (!)';
$_['entry_remarketing_feed_age_group']   = 'age_group - product attribute ID (!)';
