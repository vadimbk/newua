...
$_['entry_two_products']			   = 'Two Products in phones';
...
<p>If you cannot find the answers to the questions in this documentation, you can always ask them by writing an email <a href="mailto:support@ultrastore.octemplates.net">support@ultrastore.octemplates.net</a></p>
</div></div>
<div class="panel panel-info">
  ...
  <div class="panel-body">
  <p>All rights to the template belong to the company OCTemplates.</p>
<p><a href="https://market.octemplates.net" target="_blank">https://market.octemplates.net</a></p>
<p>License Terms: One Domain - One License. The number of licenses for test subdomains is unlimited. To obtain a license key for a test subdomain, you must write an email <a href="mailto:support@ultrastore.octemplates.net">support@ultrastore.octemplates.net</a></p>
