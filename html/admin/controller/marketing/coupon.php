...
class ControllerMarketingCoupon extends Controller {
	...
	$coupon_manufacturers = $this->request->post['coupon_manufacturer'];
} elseif (isset($this->request->get['coupon_id'])) {
	$coupon_manufacturers = $this->model_marketing_coupon->getCouponManufacturers($this->request->get['coupon_id']);
} else {
	$coupon_manufacturers = array();
}
...
$data['coupon_manufacturers'] = array();

foreach ($coupon_manufacturers as $manufacturer_id) {
