...
class ControllerCatalogShopRating extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => htmlspecialchars_decode($this->url->link('common/dashboard', 'user_token=' . $this->session->data['user_token'], true))
        );
        $data['action'] = htmlspecialchars_decode($this->url->link('catalog/shop_rating', 'user_token=' . $this->session->data['user_token'], true));

        $data['cancel'] = htmlspecialchars_decode($this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'], true));
        $data['change_status'] = htmlspecialchars_decode($this->url->link('catalog/shop_rating/status', 'user_token=' . $this->session->data['user_token'], true));
        $data['view_rate_link'] = htmlspecialchars_decode($this->url->link('catalog/shop_rating/viewRate', 'user_token=' . $this->session->data['user_token'], true));
        $data['remove_review'] = htmlspecialchars_decode($this->url->link('catalog/shop_rating/removeReview', 'user_token=' . $this->session->data['user_token'], true));
		$data['create_custom_type_url'] = htmlspecialchars_decode($this->url->link('catalog/shop_rating/custom_types', 'user_token=' . $this->session->data['user_token'], true));
    ...
    public function viewRate(){
        ...
        $data['change_status_url'] = html_entity_decode($this->url->link('catalog/shop_rating/status', 'user_token=' . $this->session->data['user_token'], true));
