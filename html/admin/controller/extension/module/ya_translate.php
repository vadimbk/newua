...
//				print_r($results);
	...
	public function attr() {
		...
		$data['viewLog']   = str_replace('&amp;','&',$this->makeUrl($this->path_module . '/viewLog'));
		$data['clearLog']  = str_replace('&amp;','&',$this->makeUrl($this->path_module . '/clearLog'));
		$data['translate'] = str_replace('&amp;','&',$this->makeUrl($this->path_module . '/bulkTranslateAttr'));
		$data['filter']    = str_replace('&amp;','&',$this->makeUrl($this->path_module . '/attr'));
			...
			foreach ($values as $value) {
				...
				foreach ($viewLanguages as $language_id=>$language) {
					$data_filter = [
						...
						'lang_source'  => $this->config->get('config_language_id'),
