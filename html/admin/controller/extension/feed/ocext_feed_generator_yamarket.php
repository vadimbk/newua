...
class ControllerExtensionFeedOcextFeedGeneratorYaMarket extends Controller {
	...
	public function __construct($registry) {
		$this->registry = $registry;
                ...
                require_once(modification(DIR_APPLICATION . 'controller/extension/feed/ocext_loader.php'));
        ...
        public function getSettingVersionSettings(){
            ...
            $setting_version_settings = $this->{$this->path_on_model}->getSettingVersionSettings();
		...
		$this->load->language($this->path_oc_version.'/ocext_feed_generator_yamarket');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
                        ...
                        if(isset($this->request->get['template_setting'])){
                            $this->{$this->path_on_model}->setSettings($this->request->post);
                            $this->session->data['success'] = $this->language->get('text_success');
                            
                            $this->response->redirect($this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL'));
                            
                        }
			elseif(isset($this->request->get['promo_gift'])){
			    
                            $this->{$this->path_on_model}->setPromoGift($this->request->post);
                            $this->session->data['success'] = $this->language->get('text_success');
			...
			elseif(isset ($this->request->get['ym_filter_data'])){
                            ...
                            if(!$filter_data_group_id){
                                $data['filter_datas'] = $this->{$this->path_on_model}->getFilterDatas();
                                $filter_datas = 0;
                            ...
                            $ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer = array();
                            
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer'])){
                                $ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer = $this->request->post['ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer'];
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer',$ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer,$filter_data_name,$filter_data_group_id,$delete);
                            }
			    
			    $ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories = array();
                            
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories'])){
                                $ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories = $this->request->post['ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories'];
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories',$ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories,$filter_data_name,$filter_data_group_id,$delete);
                            }
                            ...
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_attributes'])){
                                ...
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_attributes',$ocext_feed_generator_yamarket_ym_filter_attributes,$filter_data_name,$filter_data_group_id,$delete);
                            ...
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_options'])){
                                ...
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_options',$ocext_feed_generator_yamarket_ym_filter_options,$filter_data_name,$filter_data_group_id,$delete);
                            }
                            ...
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_manufacturers'])){
                                ...
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_manufacturers',$ocext_feed_generator_yamarket_ym_filter_manufacturers,$filter_data_name,$filter_data_group_id,$delete);
                            }
                            ...
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_category'])){
                                ...
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_category',$ocext_feed_generator_yamarket_ym_filter_category,$filter_data_name,$filter_data_group_id,$delete);
                            }
                            
                            $ocext_feed_generator_yamarket_ym_filter_columns = array();
                            if(isset($this->request->post['ocext_feed_generator_yamarket_ym_filter_columns'])){
                                $ocext_feed_generator_yamarket_ym_filter_columns = $this->request->post['ocext_feed_generator_yamarket_ym_filter_columns'];
                                $this->{$this->path_on_model}->setFilterData('ocext_feed_generator_yamarket_ym_filter_columns',$ocext_feed_generator_yamarket_ym_filter_columns,$filter_data_name,$filter_data_group_id,$delete);
                            }
                            ...
                            $this->{$this->path_on_model}->updateYmCategories($this->request->post);
                            $this->session->data['success'] = $this->language->get('text_success');
                ...
                $this->load->model($this->path_oc_version.'/ocext_feed_generator_yamarket');
                $data['template_setting'] = $this->{$this->path_on_model}->getSettings($data['setting_type'],FALSE,$setting_product_id);
		...
		$data['promoss'] = $this->{$this->path_on_model}->getPromoGift();
		
		if($data['promoss']){

                    foreach ($data['promoss'] as $key_template_setting => $value_template_setting) {

                        $data['promoss'][$key_template_setting]['promos'] = json_decode($value_template_setting['promos'],TRUE);
		...
		$data['text_no'] = $this->language->get('text_no');
                ...
                $data['text_setting_optimization_file_feed_write'] = $this->language->get('text_setting_optimization_file_feed_write');
                $data['text_setting_optimization_feed_limit_products'] = $this->language->get('text_setting_optimization_feed_limit_products');
                ...
                $data['text_general_setting_yml_cache_enable'] = $this->language->get('text_general_setting_yml_cache_enable');
                $data['text_general_setting_yml_cache_level'] = $this->language->get('text_general_setting_yml_cache_level');
                $data['text_general_setting_yml_cache_level_0'] = $this->language->get('text_general_setting_yml_cache_level_0');
                $data['text_general_setting_yml_cache_level_1'] = $this->language->get('text_general_setting_yml_cache_level_1');
                $data['text_general_setting_yml_cache_level_2'] = $this->language->get('text_general_setting_yml_cache_level_2');
                $data['text_setting_dall_categories_to_yml'] = $this->language->get('text_setting_dall_categories_to_yml');
                ...
                if(isset($this->setting_version_settings['functional']['optimization_file_feed_write']) && $this->setting_version_settings['functional']['optimization_file_feed_write']){
                    $data['optimization_file_feed_write'] = TRUE;
                }
                
                if(isset($this->setting_version_settings['functional']['optimization_feed_write']) && $this->setting_version_settings['functional']['optimization_feed_write']){
                    $data['optimization_feed_write'] = TRUE;
                }
                
                if(isset($this->setting_version_settings['functional']['optimization_feed_limit_products']) && $this->setting_version_settings['functional']['optimization_feed_limit_products']){
                    $data['optimization_feed_limit_products'] = $this->{$this->path_on_model}->getLimitProducts();
                }
                
                if(isset($this->setting_version_settings['functional']['feed_fb']) && $this->setting_version_settings['functional']['feed_fb']){
                    $data['feed_fb'] = $this->setting_version_settings['functional']['feed_fb'];
                }
		...
		if(!isset($data['ocext_feed_generator_yamarket_general_setting']['delivery_options_by_manufacturer'])){
                    $data['ocext_feed_generator_yamarket_general_setting']['delivery_options_by_manufacturer'] = 0;
                }
                ...
                $data['filter_datas_general_setting'] = $this->{$this->path_on_model}->getFilterDatas();
                ...
                foreach ($data['filter_datas_general_setting'] as $filter_data_group_id => $filter_data_name) {
                    ...
                    if(!isset($data['ocext_feed_generator_yamarket_general_setting']['filter_data'][$filter_data_group_id]['fb_filename_export'])){
                        $data['ocext_feed_generator_yamarket_general_setting']['filter_data'][$filter_data_group_id]['fb_filename_export'] = 'ocext_fb_feed';
                    }
                ...
                krsort($data['filter_datas_general_setting']);
                ...
                if($setting_product_id){
                    ...
                    return $this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_product_setting'.$this->ftype, $data);
		...
		foreach ($results as $result) {
			...
			'limit'                => $config_limit_admin_pagination
                ...
                $data['ym_categories'] = $this->{$this->path_on_model}->getYmCategoriesFromDb($filter);
		$ym_categories_total = $this->{$this->path_on_model}->getYmCategoriesFromDbTotal($filter);
                ...
                $pagination->url = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', ''.$this->token_name.'=' . $this->session->data[$this->token_name] . $url . '&ym_categories_page={page}', 'SSL');
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', ''.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL'),
      		'separator' => ' :: '
   		);
                ...
                $url = '';
                $data['action_general_setting'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&general_setting=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
		$data['action_promo_gift'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&promo_gift=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
                $data['action_template_setting'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&template_setting=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
                $data['action_ym_filter_data'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&ym_filter_data=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
                $data['action_ym_categories_filter'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&ym_categories_filter=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
                $data['action_ym_categories'] = $this->url->link($this->path_oc_version.'/ocext_feed_generator_yamarket', $url.'&ym_categories=1&'.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
                
                
                $data['cancel'] = $this->url->link($this->path_oc_version.'', ''.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL');
		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
                
		if (version_compare(VERSION, '2.2') < 0) {
			$this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/ocext_feed_generator_yamarket'.$this->ftype, $data));
		} else {
			$this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/ocext_feed_generator_yamarket', $data));
		}
                
	}
	
	public function getPromoGift() {
            
            $promos_id = (int)$this->request->get['promos_id'];
	    
            $data['promos_id'] = $promos_id;
            
            $sample_promos_id = 0;
            if(isset($this->request->get['sample_promos_id'])){
                $sample_promos_id = (int)$this->request->get['sample_promos_id'];
            }
            $data['sample_promos_id'] = $sample_promos_id;
            
            $this->load->model($this->path_oc_version.'/ocext_feed_generator_yamarket');
            
            if($sample_promos_id){
                
                $data['promoss'] = $this->{$this->path_on_model}->getPromoGift($sample_promos_id);
                
            }else{
                
                $data['promoss'] = $this->{$this->path_on_model}->getPromoGift($promos_id);
                
            }
            
            if($data['promoss']){

                foreach ($data['promoss'] as $value_template_setting) {

                    $data['promoss']['promos'] = json_decode($value_template_setting['promos'],TRUE);

                }

            }else{
                
                $data['promoss']['promos'] = array();
                
            }
                
            $data['all_promoss'] = $this->{$this->path_on_model}->getPromoGift();

            if($data['all_promoss']){

                foreach ($data['all_promoss'] as $key_template_setting => $value_template_setting) {

                    $data['all_promoss'][$key_template_setting]['promos'] = json_decode($value_template_setting['promos'],TRUE);
	    ...
	    foreach ($results as $result) {
            ...
            $data['promos_types'] = array('promo-code'=>'Промокод','flash-discount'=>'Специальная цена','n-plus-m'=>'N + M','gift-with-purchase'=>'Подарок');
            
            $this->load->language($this->path_oc_version.'/ocext_feed_generator_yamarket');
            
            $data['text_setting_rule_picture'] = $this->language->get('text_setting_rule_picture');
            $data['text_setting_rule_picture_by_wh_side'] = $this->language->get('text_setting_rule_picture_by_wh_side');
            $data['text_setting_rule_picture_by_h_side'] = $this->language->get('text_setting_rule_picture_by_h_side');
            $data['text_setting_rule_picture_by_w_side'] = $this->language->get('text_setting_rule_picture_by_w_side');
            $data['text_setting_rule_picture_no_cache'] = $this->language->get('text_setting_rule_picture_no_cache');
            ...
            $data['text_setting_name_composite_element_product_meta_title'] = $this->language->get('text_setting_name_composite_element_product_meta_title');
            $data['text_setting_name_composite_element_product_meta_description'] = $this->language->get('text_setting_name_composite_element_product_meta_description');
            $data['text_template_setting_sample_setting'] = $this->language->get('text_template_setting_sample_setting');
            ...
            $data['text_setting_custom_offer_id'] = $this->language->get('text_setting_custom_offer_id');
            ...
            $data['text_setting_replace_av_false'] = $this->language->get('text_setting_replace_av_false');
            $data['text_setting_replace_av_true'] = $this->language->get('text_setting_replace_av_true');
            $data['text_setting_replace_tags'] = $this->language->get('text_setting_replace_tags');
            ...
            $data['text_setting_fb_condition'] = $this->language->get('text_setting_fb_condition');
            $data['fb_conditions'] = array('new'=>'Новый','refurbished'=>'После ремонта','used'=>'Бывший в употреблении');
            $data['text_setting_all_product_category'] = $this->language->get('text_setting_all_product_category');
            ...
            $data['debug'] = $this->debug;
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_promo_gift'.$this->ftype, $data));
        ...
        public function getTemplateSetting() {
            ...
            if($sample_setting_id){
                ...
                $data['template_setting'] = $this->{$this->path_on_model}->getSettings(FALSE,$sample_setting_id);
                
            }else{
                
                $data['template_setting'] = $this->{$this->path_on_model}->getSettings($setting_type,$setting_id);
            ...
            $data['all_template_setting'] = $this->{$this->path_on_model}->getSettings();
            ...
            $data['offer_description_parts'] = $this->{$this->path_on_model}->getOfferNameParts(TRUE);
            ...
            if(isset($this->setting_version_settings['functional']['rule_pictures']) && $this->setting_version_settings['functional']['rule_pictures']){
                $data['rule_pictures'] = $this->{$this->path_on_model}->getRulePictures();
            }
            
            if(isset($this->setting_version_settings['functional']['currency_convert']) && $this->setting_version_settings['functional']['currency_convert']){
                $data['currencies'] = $this->{$this->path_on_model}->getCurrencies();
            }
            
            if(isset($this->setting_version_settings['functional']['sales_note_by_rule']) && $this->setting_version_settings['functional']['sales_note_by_rule']){
                $data['sales_note_by_rule'] = $this->{$this->path_on_model}->getAdvancedSettings(array('template_setting'=>$data['template_setting']),'sales_note_by_rule');
            }
            ...
            if(isset($this->setting_version_settings['functional']['divide_by_options']) && $this->setting_version_settings['functional']['divide_by_options']){
                $divide_by_options_param = array(
                    'template_setting'=>$data['template_setting'],
                    'setting_type'=>$setting_type,
                    'sample_setting_id'=>$sample_setting_id,
                    'setting_id'=>$setting_id,
                    'path_oc_version'=>$this->path_oc_version,
                );
                $data['divide_by_options'] = $this->{$this->path_on_model}->getAdvancedSettings($divide_by_options_param,'divide_by_options');
            }
            ...
            $data['entry_template_setting_attribute_sintaxis_1'] = $this->language->get('entry_template_setting_attribute_sintaxis_1');
            $data['debug'] = $this->debug;
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_setting_form'.$this->ftype, $data));
        ...
        public function getSettingFields() {
            ...
            $data['text_setting_name_composite_element_product_meta_keyword'] = $this->language->get('text_setting_name_composite_element_product_meta_keyword');
            ...
            if(strstr($data['name_field'], 'divide_on_option_option_id') || strstr($data['name_field'], 'divide_on_options_option_id')){
                $divide_on_option_option_id = TRUE;
            }
            
            $data['content_parts'] = $this->{$this->path_on_model}->getContentParts($data['name_field'],$divide_on_option_option_id);
            $data['setting_fields'] = $this->{$this->path_on_model}->getSettingFields($data['content_parts']);
            $data['attributes'] = $this->{$this->path_on_model}->getAttributes();
            $data['options'] = $this->{$this->path_on_model}->getOptions();
            ...
            if($sample_setting_id){
                ...
                $data['template_setting'] = $this->{$this->path_on_model}->getSettings($setting_type,$data['setting_id']);
            ...
            if(!isset($data['template_setting']['setting']['custom_offer_id'])){
                
                $data['template_setting']['setting']['custom_offer_id']['field']['status'] = 'product_id';
                
            }
            
            $data['debug'] = $this->debug;
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_setting_fields'.$this->ftype, $data));
        }

        private function validate() {
            
		if (!$this->user->hasPermission('modify', $this->path_oc_version.'/ocext_feed_generator_yamarket')) {
	    ...
	    $ocext_feed_generator_yamarket_general_setting = $this->config->get('ocext_feed_generator_yamarket_general_setting');
            
            if(isset($this->request->get['categories'])){
                $this->load->model('catalog/category');
                $data['categories'] = $this->model_catalog_category->getCategories(0);
                $data['ym_categories'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_category',FALSE,$filter_data_group_id);
		if( isset($ocext_feed_generator_yamarket_general_setting['mapping_market_place_categories']) && $ocext_feed_generator_yamarket_general_setting['mapping_market_place_categories'] && isset($this->setting_version_settings['functional']['mapping_market_place_categories']) && $this->setting_version_settings['functional']['mapping_market_place_categories']){
                    $data['mapping_market_place_categories'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_mapping_market_place_categories',FALSE,$filter_data_group_id);
                }
            }elseif(isset($this->request->get['manufacturers'])){
                $this->load->model('catalog/manufacturer');
                $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
                $data['ym_manufacturers'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_manufacturers',FALSE,$filter_data_group_id);
                if( isset($ocext_feed_generator_yamarket_general_setting['delivery_options_by_manufacturer']) && $ocext_feed_generator_yamarket_general_setting['delivery_options_by_manufacturer'] && isset($this->setting_version_settings['functional']['delivery_option_by_manufacturer']) && $this->setting_version_settings['functional']['delivery_option_by_manufacturer']){
                    $data['delivery_option_by_manufacturer'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_delivery_option_by_manufacturer',FALSE,$filter_data_group_id);
                }
                
            }elseif(isset($this->request->get['options'])){
                $data['options'] = $this->{$this->path_on_model}->getOptions();
                $data['ym_options'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_options',FALSE,$filter_data_group_id);
            }elseif(isset($this->request->get['attributes'])){
                $data['attributes'] = $this->{$this->path_on_model}->getAttributes();
                $data['ym_attributes'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_attributes',FALSE,$filter_data_group_id);
            }elseif(isset($this->request->get['columns'])){
                $data['columns'] = $this->{$this->path_on_model}->getProductColumns();
                $data['ym_columns'] = $this->{$this->path_on_model}->getFilterData('ocext_feed_generator_yamarket_ym_filter_columns',FALSE,$filter_data_group_id);
                if(isset($this->setting_version_settings['functional']['filter_by_pcolumns']) && $this->setting_version_settings['functional']['filter_by_pcolumns']){
                    $data['operators'] = $this->{$this->path_on_model}->getSqlWhereOperators();
                    $data['logics'] = $this->{$this->path_on_model}->getSqlWhereLogic();
                }
            ...
            $data['setting_type'] = 'template_setting';
            $this->load->model($this->path_oc_version.'/ocext_feed_generator_yamarket');
            $data['templates_setting'] = $this->{$this->path_on_model}->getSettings($data['setting_type'],FALSE,0);
            ...
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_ym_filter_data'.$this->ftype, $data));
        }
        ...
        public function settingFieldsYamarketGetOptOrAtr() {
            ...
            $data['debug'] = $this->debug;
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_setting_fields_opt_atr'.$this->ftype, $data));
        ...
        public function getCategories() {
            ...
            $ym_categories = $this->{$this->path_on_model}->getYmCategoriesFromDb($filter_ym_categories);
            ...
            $this->response->setOutput($this->{$this->loader}->view($this->path_oc_version.'/feed_generator/ocext_feed_generator_yamarket_ym_categories_categories'.$this->ftype, $data));
        }
        
        public function getNotifications() {
                $module_name = $this->path_oc_version.'/ocext_feed_generator_yamarket';
		sleep(1);
