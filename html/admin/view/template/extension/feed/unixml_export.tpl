      ...
      <form style="overflow-y:scroll;" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-unixml-export" class="form-horizontal">
        <input type="hidden" name="feed" value="<?php echo $feed; ?>">
          ...
          <div id="export-block-3" class="export-block-item">
            ...
            <!--3.9-->
              <div class="form-group" id="export-block-3-9">
                ...
                <div class="col-sm-10 table-responsive" style="<?php /*overflow-y:scroll;max-height:730px;*/ ?>">
          ...
          <div id="export-block-5" class="export-block-item">
            ...
            <!--5.8-->
              <div class="form-group" id="export-block-5-8">
                <span class="field_counter">5.8</span>
                <label class="col-sm-2 control-label">
                  <a href="https://unixml.pro/set/export/5-8" target="_blank">
                    <?php echo $text_export_5_8; ?>
                    <div class="help">
                      <?php echo $text_export_help_title; ?>
                      <?php echo $text_export_5_8_help; ?>
                    </div>
                  </a>
                </label>
                <div class="col-sm-10">

                  <div id="unixml_<?php echo $feed; ?>_store" style="padding-top:6px;">
                    <?php foreach($stores as $store){ ?>
                      <span style="margin-right:10px;" title="store">
                        <input class="checkbox_exp_mini" type="checkbox" id="store-<?php echo $store['store_id']; ?>" name="unixml_<?php echo $feed; ?>_store[]" value="<?php echo $store['store_id']; ?>" <?php if (in_array($store['store_id'], $unixml_store)) { ?>checked="checked"<?php } ?> />
                        <label for="store-<?php echo $store['store_id']; ?>">&nbsp;<?php echo $store['name']; ?></label>
                      </span>
                     <?php } ?>
                  </div>
