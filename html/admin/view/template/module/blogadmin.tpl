<div id="blog-menu_admin" style="display: none;">
      <li id="seocms-menu">
      <a href="<?php echo $url_module; ?>" class="top parent collapsed"><i class="fa fa-list fa-fw"></i><span><?php echo $url_module_text; ?></span></a>
        <ul id="collapse999" style="width: 260px;" class="">
