...
class ModelCatalogAttribute extends Model {
	...
	public function getAttributes($data = array()) {
		...
		if (!empty($data['filter_name'])) {
			...
			$fnames = explode('||',$data['filter_name']);
			$ors = [];
			foreach ($fnames as $fname) {
				$ors[] = " a.attribute_id LIKE '" . $this->db->escape(trim($fname)) . "%'";
				$ors[] = " ad.name LIKE '%" . $this->db->escape(trim($fname)) . "%'";
			}
		...
		if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
			...
			if (!empty($data['filter_attribute_group_id'])) {
				if (isset($data['sort'])) {
					if ($data['sort'] != 'a.sort_order') {
						$data['sort'] = 'a.sort_order, ad.name';
						$sort_data[] = 'a.sort_order, ad.name';
					}
				} else {
					$data['sort'] = 'a.sort_order, ad.name';
					$sort_data[] = 'a.sort_order, ad.name';
	...
	public function getTotalAttributesOLD() {
