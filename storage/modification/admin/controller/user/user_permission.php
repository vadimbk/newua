...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<=') && !in_array('extension/ocdevwizard/in_stock_alert', $data['permissions'])) {
          $data['permissions'][] = 'extension/ocdevwizard/in_stock_alert';
        }
