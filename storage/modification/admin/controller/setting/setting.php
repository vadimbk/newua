...
if (isset($this->request->post['config_enable_ext_allowed_files'])) {
    $data['config_enable_ext_allowed_files'] = $this->request->post['config_enable_ext_allowed_files'];
} else {
    $data['config_enable_ext_allowed_files'] = $this->config->get('config_enable_ext_allowed_files');
}
