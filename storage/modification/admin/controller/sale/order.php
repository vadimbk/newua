...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
        ...
        if ($this->config->get('order_source_status') && $this->config->get('order_source_referer')){
          $data['referer_status'] = true;
        } else {
          $data['referer_status'] = false;
        }
        if ($this->config->get('order_source_status') && $this->config->get('order_source_utm_source')){
          $data['utm_source_status'] = true;
        } else {
          $data['utm_source_status'] = false;
        }
        if ($this->config->get('order_source_status') && $this->config->get('order_source_utm_medium')){
          $data['utm_medium_status'] = true;
        } else {
          $data['utm_medium_status'] = false;
        }
        if ($this->config->get('order_source_status') && $this->config->get('order_source_utm_campaign')){
          $data['utm_campaign_status'] = true;
        } else {
          $data['utm_campaign_status'] = false;
        }
        if ($this->config->get('order_source_status') && $this->config->get('order_source_utm_content')){
          $data['utm_content_status'] = true;
        } else {
          $data['utm_content_status'] = false;
        }
        if ($this->config->get('order_source_status') && $this->config->get('order_source_utm_term')){
          $data['utm_term_status'] = true;
        } else {
          $data['utm_term_status'] = false;
        }
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$data['coupon_title'] = $this->model_sale_order->getOrderCoupon($this->request->get['order_id']);
	...
	public function info() {
        ...
        if (strpos($order_info['payment_code'], 'liqpayplus') !== false && $this->config->get('payment_'.$order_info['payment_code'].'_status')){
          $this->language->load('extension/payment/liqpaypro');
          $this->language->load('extension/payment/'.$order_info['payment_code']);
          $data['liqpayprotext'] = $this->language->get('pay_text_admin');
          $this->load->model('extension/payment/liqpayplus');
          $data['liqpaypro_link'] = $this->model_extension_payment_liqpayplus->getCustomFields($order_info, 'href');
        }
