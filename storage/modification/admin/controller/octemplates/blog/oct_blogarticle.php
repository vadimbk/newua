...
class ControllerOCTemplatesBlogOCTBlogArticle extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['faq'])) {
			...
			$faq = $this->model_octemplates_blog_oct_blogarticle->getBlogArticleFaq($this->request->get['blogarticle_id']);
		} else {
			$faq = [];
		}
		$data['blog_article_faq'] = [];
		foreach ($faq as $information_faq) {
			$data['blog_article_faq'][] = [
				'faq_data' => $information_faq['faq_data'],
...
/*if (isset($this->request->post['blogauthor_id'])) {
			$data['blogauthor_id'] = $this->request->post['blogauthor_id'];
		} elseif (!empty($article_info)) {
			$data['blogauthor_id'] = $article_info['blogauthor_id'];
		} else {
			$data['blogauthor_id'] = 0;
		}*/
		...
		if (isset($this->request->post['author'])) {
			...
			$author_info = $this->model_octemplates_blog_oct_blogauthor->getAuthor($article_info['blogauthor_id']);
		...
		/*if (isset($this->request->post['author'])) {
			...
			$data['author'] = $this->model_octemplates_blog_oct_blogarticle->getArticleAuthor($this->request->get['blogarticle_id']);
		} else {
			$data['author'] = ''];
		}*/
...
foreach ($author as $blogblogauthor_id) {
		$blog_author_info = $this->model_octemplates_blog_oct_blogauthor->getAuthor($blogblogauthor_id);
		echo $blog_author_info;

			if ($blog_author_info) {
				$data['article_author'][] = [
					'blogcblogauthor_id' => $blog_author_info['blogblogauthor_id'],
					'name'        => $blog_author_info['name']
				];
			}
}*/
		...
		if (isset($this->request->post['author'])) {
			...
			$author_info =$this->model_octemplates_blog_oct_blogarticle->getArticleAuthor($this->request->get['blogarticle_id']);
