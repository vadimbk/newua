...
class ControllerExtensionModuleSpecial extends Controller {
    ...
    if (!empty($promotion_options['promotion']['specials'])) {
      $filter_data['filter_promotion'] = 1;
      $results = $this->model_extension_module_promotion->getProductSpecials($filter_data);
    } else {
