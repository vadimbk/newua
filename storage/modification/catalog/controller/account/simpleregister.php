...
class ControllerAccountSimpleRegister extends SimpleController {
    ...
    public function index($args = null) {
		...
		if(isset($this->request->post['register']['email'])){
			$email = $this->request->post['register']['email'];
		}else{
			$email = '';
		}
		if(isset($this->request->post['register']['telephone'])){
			$telephone = preg_replace('/[^0-9]/','',$this->request->post['register']['telephone']);
			...
			if($this->model_account_customer->getLoginTele($telephone)){
		...
		if(isset($this->request->post['register']['email']) || isset($this->request->post['register']['telephone'])){
			$this->request->post['register']['email'] = $email;
			$this->request->post['register']['telephone'] = $telephone;
		}
