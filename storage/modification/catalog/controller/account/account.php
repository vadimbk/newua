...
class ControllerAccountAccount extends Controller {
	public function index() {
        ...
        $data['text_ocdw_in_stock_alert'] = $this->language->get('text_ocdw_in_stock_alert');

        if (isset($ocdw_in_stock_alert_form_data['activate']) && $ocdw_in_stock_alert_form_data['activate']) {
          $data['ocdw_in_stock_alert'] = $this->url->link('extension/ocdevwizard/in_stock_alert/page', '', 'SSL');

          $data['ocdw_in_stock_alert_status'] = 1;
        } else {
          $data['ocdw_in_stock_alert_status'] = 0;
        }
