...
class ControllerCommonContentBottom extends Controller {
	public function index() {
		...
		$layout_id = 0;
			...
			if ($route == 'octemplates/blog/oct_blogauthor' && isset($this->request->get['blogauthor_id'])) {
				$this->load->model('octemplates/blog/oct_blogauthor');

				$layout_id = $this->model_octemplates_blog_oct_blogauthor->getAuthorLayoutId($this->request->get['blogauthor_id']);
			}
