			...
			foreach ($results as $result) {
				if ($this->config->get('payment_' . $result['code'] . '_status')) {
					...
					if ($method) {
						...
						/** EET Module */
						if ($this->config->get('module_ee_tracking_status') && $this->config->get('module_ee_tracking_checkout_status') && $this->config->get('module_ee_tracking_advanced_settings') && $this->config->get('module_ee_tracking_language_id') && isset($this->session->data['language']) && $this->session->data['language'] != $this->config->get('module_ee_tracking_language_id')) {
							$this->load->model('localisation/language');
							$ee_languages = $this->model_localisation_language->getLanguages();
							foreach ($ee_languages as $ee_item) {
								if ($ee_item['language_id'] == $this->config->get('module_ee_tracking_language_id')) {
