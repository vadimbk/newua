<?php
        ...
        $_['text_ocdw_in_stock_alert'] = 'Повідомлення - коли товар буде в наявності';
...
$_['text_my_notifications'] = 'Заявки на повідомлення';
				$_['text_notifications'] = 'Мої заявки про надходження товару';
