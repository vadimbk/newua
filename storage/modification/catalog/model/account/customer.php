...
class ModelAccountCustomer extends Model {
	...
	public function getLoginTele($telephone) {
		$query = $this->db->query("SELECT email FROM `" . DB_PREFIX . "customer` WHERE telephone = '" . $this->db->escape(utf8_strtolower($telephone)) . "'");
		if($query->row){
