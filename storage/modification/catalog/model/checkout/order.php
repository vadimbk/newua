...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
        ...
        $referer = (!empty($_COOKIE['referer'])) ? $_COOKIE['referer'] : null;
        $utm_source = (!empty($_COOKIE['utm_source'])) ? $_COOKIE['utm_source'] : null;
        $utm_medium = (!empty($_COOKIE['utm_medium'])) ? $_COOKIE['utm_medium'] : null;
	      $utm_campaign = (!empty($_COOKIE['utm_campaign'])) ? $_COOKIE['utm_campaign'] : null;
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
        ...
        if ($order_info['order_status_id'] && $order_status_id) {
          if (strpos($order_info['payment_code'], 'liqpayplus') !== false && $this->config->get('payment_'.$order_info['payment_code'].'_status')){
                if ($this->config->get('payment_'.$order_info['payment_code'].'_on_status_id') == $order_status_id){
                  ...
                  $merchant = $this->model_extension_payment_liqpayplus->getCustomFields($order_info, 'href');
